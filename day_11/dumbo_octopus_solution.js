...
function solution2(inputs, rows, cols, expectedResults) {
  let dict = {};
  let a9 = {};
  ...
  if (resultt !== expectedResults) {
    return solution2(resultt, rows, cols, expectedResults);
  }
...
flashes = 0;
const expectedResults = Array.from(new Array(i.length))
  .map(() => "0")
  .join("");
console.log(solution2(i, cols, rows, expectedResults));
